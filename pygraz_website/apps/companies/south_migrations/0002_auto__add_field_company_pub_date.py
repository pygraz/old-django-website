...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Company.pub_date'
        db.add_column(
            "companies_company",
            "pub_date",
            self.gf("django.db.models.fields.DateTimeField")(
                auto_now_add=True, default=datetime.datetime(2013, 5, 18, 0, 0), blank=True
            ),
            keep_default=False,
        )

    def backwards(self, orm):
        # Deleting field 'Company.pub_date'
        db.delete_column("companies_company", "pub_date")
