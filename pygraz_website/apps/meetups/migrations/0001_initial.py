    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.ForeignKey(
                        blank=True, to="meetups.Location", null=True, on_delete=django.db.models.deletion.PROTECT
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        verbose_name="Status",
                        choices=[(b"not_coming", "Not coming"), (b"coming", "Coming"), (b"maybe", "Maybe")],
                    ),
                ),
                (
                    "gplus_name",
                    models.CharField(max_length=100, null=True, verbose_name="Google+ Username", blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "speaker_email",
                    models.EmailField(max_length=75, null=True, verbose_name=b"E-Mail-Adresse", blank=True),
                ),
