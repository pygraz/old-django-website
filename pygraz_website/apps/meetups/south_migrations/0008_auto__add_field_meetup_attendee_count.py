...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meetup.attendee_count'
        db.add_column('meetups_meetup', 'attendee_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Meetup.attendee_count'
        db.delete_column('meetups_meetup', 'attendee_count')
    ...
    models = {
        ...
        'meetups.rsvp': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meetup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rsvps'", 'to': "orm['meetups.Meetup']"}),
        ...
        'meetups.session': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meetup': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sessions'", 'null': 'True', 'to': "orm['meetups.Meetup']"}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
