...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'meetups_sessiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'meetups', ['SessionType'])

        # Adding field 'Session.type'
        db.add_column(u'meetups_session', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetups.SessionType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SessionType'
        db.delete_table(u'meetups_sessiontype')

        # Deleting field 'Session.type'
        db.delete_column(u'meetups_session', 'type_id')
    ...
    models = {
        ...
        u'meetups.session': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetups.SessionType']", 'null': 'True', 'blank': 'True'})
        },
