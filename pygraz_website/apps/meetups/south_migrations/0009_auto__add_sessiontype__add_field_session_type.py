...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.send_create_signal("meetups", ["SessionType"])
    ...
    def backwards(self, orm):
        ...
        db.delete_table("meetups_sessiontype")

        # Deleting field 'Session.type'
        db.delete_column("meetups_session", "type_id")
    ...
    models = {
        ...
        "meetups.session": {
            ...
            "type": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"to": "orm['meetups.SessionType']", "null": "True", "blank": "True"},
            ),
        },
        "meetups.sessiontype": {
